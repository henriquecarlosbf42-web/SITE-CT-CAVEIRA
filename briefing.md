...
CT Caveira — academia de Jiu-Jitsu onde Rodrigo Zanella é professor. Projeto de graça (sem cobrança), mas com objetivo comercial real.

## Objetivo

Divulgar a estrutura da academia e atrair mais alunos. Complementa a landing page de patrocínio do Rodrigo (projeto `Sensei Zanella JJ`) — as duas páginas vão se linkar.

## Entregas

- Landing page institucional (estrutura, aulas, professores, diferenciais)
- Conteúdo pra redes sociais
- Material de captação de alunos

## Dados confirmados (Instagram @ctcaveira.sjc)

- **Nome:** CT Caveira • Jiu Jitsu
- **Bio/tagline:** "Disciplina • Respeito • Evolução" — Jiu-Jitsu infantil e adulto, treinos/técnica/competição
- **Seguidores:** 5.122
- **Endereço:** Praça Mikado, 74 — Jardim Oriente, São José dos Campos/SP
- **Horários:** Terça e quinta, 9h–17h e 19h30 · Sábado, 9h
